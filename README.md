...
Cada ejercicio incluye una ilustración SVG animada autoalojada y una guía de ejecución con tres pasos, señales de postura, respiración y errores que deben evitarse. Las guías cubren 24 patrones de movimiento y también se generan para ejercicios personalizados a partir de su categoría y nombre. Se muestran en la biblioteca y durante el entrenamiento guiado, funcionan sin conexión y respetan la preferencia del sistema para reducir movimiento.
